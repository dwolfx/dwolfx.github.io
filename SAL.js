/* Prebid - function that calls the ad-server */
...
if (hasAdSitePage || isSiteOptimizationEnabled()) {
  ...
  */
  ...
  /* SAL */
  /* load your Demand Manager Prebid library before GPT
<script async src="//ads.rubiconproject.com/prebid/11366_test_globo_wrapper_test.js"></script> */

  /* load Demand Manager Prebid library before GPT */
  if (typeof (pbjs && pbjs.que) == "undefined") {
    var pbjs = pbjs || {};
    pbjs.que = pbjs.que || [];

    (function() {
      var pbjsS = document.createElement("script");
      pbjsS.async = true;
      pbjsS.type = "text/javascript";
      var useSSL = "https:" == document.location.protocol;
      pbjsS.src =
        (useSSL ? "https:" : "http:") +
        "//ads.rubiconproject.com/prebid/11366_test_globo_wrapper_test.js";
      var node = document.getElementsByTagName("script")[0];
      node.parentNode.insertBefore(pbjsS, node);
    })();
  }
  ...
  function aba_ativa(e) {
    ...
    try {
      googletag.cmd.push(function() {
        ...
        //SAL ADDED
        var prebidData = { inventory: {}, visitor: {} };
        prebidData.inventory = {
          adunit: adUnit,
          ambient: pageData.ambient,
          glb_id: pageData.glb_id,
          glb_tipo: pageData.glb_tipo,
          tvg_pgTipo: pageData.tvg_pgTipo
        };
        prebidData.visitor = {
          kuid: pageData.kuid,
          ognCluster: pageData.ognCluster
        };
        ...
        (function(w) {
          try {
            ...
            //SAL ADDED
            prebidData.visitor.push(persona);
